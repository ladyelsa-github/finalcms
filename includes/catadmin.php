  ...
  <div class="row">
                  ...
                  $registros = mysqli_query($conexion,$consulta);
                          while ($row = mysqli_fetch_array($registros)) { ?>
                            <tr>
                                ...
                                <td> 
                                  <a href="includes/actualizarcat.php?id=<?php echo $row['post_id'] ?>" class="btn btn-secondary">
                                  <i class="fas fa-marker"> Edit</i>
                                  </a>
                                  
                                  <a href="includes/accioncat.php?id=<?php echo $row['post_id']."&ac=3" ?>" class="btn btn-danger"> 
    ...
    <div class="col-md-6" >
			<div class="card card-body">
				<form method="POST" action="includes/accioncat.php?ac=1">
